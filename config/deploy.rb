...
role :web, "group2.com"                          # Your HTTP server, Apache/etc
role :app, "group2.com"                         # This may be the same as your `Web` server
role :db,  "group2.com"   , :primary => true # This is where Rails migrations will run
